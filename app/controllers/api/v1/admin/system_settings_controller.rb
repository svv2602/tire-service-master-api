  ...
  module V1
    module Admin
      ...
      class SystemSettingsController < AdminController
        ...
        # === МЕТОДЫ ДЛЯ УПРАВЛЕНИЯ ДАННЫМИ ШИН ===

        # GET /api/v1/admin/system_settings/tire_data/status
        def tire_data_status
          begin
            stats = {
        ...
        # POST /api/v1/admin/system_settings/tire_data/validate_files
        def validate_tire_data_files
        ...
        # POST /api/v1/admin/system_settings/tire_data/import
        def import_tire_data
          csv_path = params[:csv_path]
        ...
        # DELETE /api/v1/admin/system_settings/tire_data/version/:version
        def delete_tire_data_version
        ...
        # POST /api/v1/admin/system_settings/tire_data/rollback/:version
        def rollback_tire_data
