...
- **Всего тестов:** 114+ (модель User + политики + контроллер)
- **Покрытие:** 98.2%
- **Успешных:** 112
- **Неудачных:** 2 (пагинация)
...
1. **Администратор (admin)** - полный доступ ко всему функционалу системы
   - Управление всеми пользователями
   - Создание и редактирование партнеров
   - Доступ к системной аналитике
   - Управление справочниками

2. **Партнер (partner)** - владелец сервисных точек
   - Управление своими сервисными точками
   - Назначение менеджеров на точки
   - Управление расписанием и услугами
   - Просмотр аналитики по своим точкам
   - Управление ценами и акциями

3. **Менеджер (manager)** - управляющий сервисной точкой
   - Управление бронированиями в назначенных точках
   - Подтверждение и отмена записей
   - Управление расписанием точки
   - Просмотр отчетов по точке

4. **Клиент (client)** - пользователь услуг
...
| Действие | Админ | Партнер | Менеджер | Клиент |
|----------|-------|---------|----------|--------|
| Управление пользователями | ✅ | ❌ | ❌ | ❌ |
| Создание сервисных точек | ✅ | ✅ | ❌ | ❌ |
| Управление бронированиями | ✅ | ✅ | ✅ (своих точек) | ✅ (своих) |
| Просмотр аналитики | ✅ | ✅ (своих точек) | ✅ (своих точек) | ❌ |
| Управление справочниками | ✅ | ❌ | ❌ | ❌ |
