...
priority_seeds = [
  ...
  'car_types.rb',               # Типы автомобилей
      'car_brands_and_models_improved.rb',   # Бренды и модели автомобилей с логотипами
...
service_seeds = [
  ...
  '04_service_point_photos.rb', # Фотографии сервисных точек
  '05_reviews.rb'               # Отзывы о сервисных точках
]
