...
seo_data = [
  ...
  # Статьи
  {
    page_type: 'article',
    language: 'uk',
    title: 'Експертні статті про шини - Твоя Шина',
  ...
  },
  {
    page_type: 'article',
    language: 'ru',
    title: 'Экспертные статьи о шинах - Твоя Шина',
  ...
  # Админ панель (приватная страница)
  {
    ...
    description: 'Комплексна панель управління системою шиномонтажу для адміністраторів. Керування записами клієнтів, сервісними точками, партнерами та звітністю.',
  ...
  },
  {
    ...
    description: 'Комплексная панель управления системой шиномонтажа для администраторов. Управление записями клиентов, сервисными точками, партнерами и отчетностью.',
  ...
  # Вход в систему (приватная страница)
  {
    ...
    description: 'Увійдіть в особистий кабінет для управління записами на шиномонтаж, перегляду історії обслуговування та налаштування профілю клієнта.',
  ...
  },
  {
    ...
    description: 'Войдите в личный кабинет для управления записями на шиномонтаж, просмотра истории обслуживания и настройки профиля клиента.',
  ...
  # Регистрация (приватная страница)
  {
    ...
    description: 'Створіть особистий кабінет для зручного онлайн запису на шиномонтаж, отримання знижок та відстеження історії обслуговування.',
  ...
  },
  {
    ...
    description: 'Создайте личный кабинет для удобной онлайн записи на шиномонтаж, получения скидок и отслеживания истории обслуживания.',
